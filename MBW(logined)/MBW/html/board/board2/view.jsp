...
//Step 4: 執行 SQL 指令, 若要操作記錄集, 需使用executeQuery, 才能傳回ResultSet	
           sql="SELECT * FROM `board2`"; //算出共幾筆留言
		   ...
		   out.print("<center><img src='../../shopcar/images/02.png' width='400' height='250'><br>BMW 2.</center>");
		  out.println("<br><hr>");
...
//Step 5: 顯示結果 
           ...
           //遞減排序, 讓最新的資料排在最前面
           sql="SELECT * FROM `board2` ORDER BY `GBNO` DESC LIMIT ";
           sql+=start_record+",5";
