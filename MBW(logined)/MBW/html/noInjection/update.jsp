...
if(session.getAttribute("id") != null ){
	...
	con.createStatement().execute(sql);	
	sql = "UPDATE `members` SET `name`='"+request.getParameter("name")+"' WHERE `id`='"+session.getAttribute("id")+"'";
	con.createStatement().execute(sql);	
	sql = "UPDATE `members` SET `mail`='"+request.getParameter("mail")+"' WHERE `id`='"+session.getAttribute("id")+"'";
	con.createStatement().execute(sql);	
